...
namespace ProjectDeliv.Domain.CommandHandlers
{
    public abstract class CommandHandlerBase
    {
        ...
        protected readonly IEventStoreRepositorio EventStoreRepositorio;
        protected readonly IMapper Mapper;

        protected CommandHandlerBase(INotificationHandler<DomainNotification> notifications, IMediator mediator, IUnitOfWork uow, IMapper mapper, IEventStoreRepositorio eventStoreRepositorio)
        {
            _notifications = (DomainNotificationHandler)notifications;
            _mediator = mediator;
            _uow = uow;
            Mapper = mapper;
            EventStoreRepositorio = eventStoreRepositorio;
        }
